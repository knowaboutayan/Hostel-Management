...
return (
    ...
    <div className=" gap-2 flex sticky top-0 flex-wrap mb-2 justify-between   px-5 py-2  bg-gray-100 border-green-500 w-full font-medium text-2xl border-b-4  text-green-600">
